...
// // Confirm payment
// if (isset($_POST['confirm']) && isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
...
if ($products_in_cart) {
    ...
    $stmt = $pdo->prepare('SELECT * FROM products WHERE id_product IN (' . $array_to_question_marks . ')');
    ...
    // $query = 'SELECT * FROM products WHERE id IN (' . $array_to_question_marks . ')';
